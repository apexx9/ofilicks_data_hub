...
const EONB_API_KEY = Deno.env.get("EONB_API_KEY") || "17|EOnB1gYNjudGGuQHDAHD7mfhAhKUE1GT3dDZowWF8d0cf4f0";
const GODLYDATA_API_KEY = Deno.env.get("GODLYDATA_API_KEY") || "7|L85ClQ9Js0isROgsYjRXhmQE6hOuyJryrxBWhNua4ea257e2";
